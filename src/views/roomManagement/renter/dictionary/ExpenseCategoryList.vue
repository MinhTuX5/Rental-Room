<template>
  <v-container class="expense-category-list">
    <t-feature
      :ref="refToolBar"
      class="pb-4"
      search-label="Tên loại phí chi"
      @on-click="viewDetail"
      @search="onSearch"
      @refresh="refresh"
    ></t-feature>
...
<script>
import { useExpenseCategoryList } from "./expenseCategoryList";
...
export default {
  ...
  setup() {
    const resource = useExpenseCategoryList();
    return { ...resource };
  },
};
</script>
